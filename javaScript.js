...
var wordList = {
	Country:[ 'TURKMENISTAN',	'PHILIPPINES',	'AZERBAIJAN',	'BANGLADESH',	'MADAGASCAR',	'MONTENEGRO',	'MOZAMBIQUE',	'TAJIKISTAN',	'MAURITANIA',	'AUSTRALIA',	'GUATEMALA',	'INDONESIA',	'LITHUANIA',	'MACEDONIA',	'SWAZILAND',	'NICARAGUA',	'SINGAPORE',	'BOTSWANA',	'BARBADOS',	'BULGARIA',	'CAMBODIA',	'COLOMBIA',	'DJIBOUTI',	'DOMINICA',	'HONDURAS',	'MALAYSIA',	'MALDIVES',	'MONGOLIA',	'PORTUGAL',	'SLOVAKIA',	'SLOVENIA',	'SURINAME',	'TANZANIA',	'THAILAND',	'ZIMBABWE',	'PARAGUAY',	'CROATIA',	'DENMARK',	'ECUADOR',	'ERITREA',	'JAMAICA',	'ALBANIA',	'ALGERIA',	'ARMENIA',	'AUSTRIA',	'BAHAMAS',	'BAHRAIN',	'BELARUS',	'BELGIUM',	'BOLIVIA',	'BURUNDI',	'ESTONIA',	'FINLAND',	'GEORGIA',	'GERMANY',	'HUNGARY',	'ICELAND',	'LEBANON',	'LIBERIA',	'MOLDOVA',	'MOROCCO',	'NIGERIA',	'ROMANIA',	'UKRAINE',	'VIETNAM',	'NAMIBIA',	'SENEGAL',	'SOMALIA',	'TUNISIA',	'URUGUAY',	'ISRAEL',	'KOSOVO',	'ANGOLA',	'BELIZE',	'BHUTAN',	'BRAZIL',	'BRUNEI',	'CANADA',	'CYPRUS',	'FRANCE',	'GAMBIA',	'GREECE',	'GUINEA',	'GUYANA',	'JORDAN',	'KUWAIT',	'LATVIA',	'MALAWI',	'MEXICO',	'MONACO',	'NORWAY',	'PANAMA',	'POLAND',	'SERBIA',	'SWEDEN',	'TAIWAN',	'RWANDA',	'TURKEY',	'UGANDA',	'ZAMBIA',	'SAMOA',	'BENIN',	'CHILE',	'CHINA',	'CONGO',	'EGYPT',	'SPAIN',	'GHANA',	'HAITI',	'JAPAN',	'KENYA',	'LIBYA',	'MALTA',	'NEPAL',	'NIGER',	'PALAU',	'QATAR',	'SYRIA',	'YEMEN',	'CHAD',	'CUBA',	'FIJI',	'IRAN',	'IRAQ',	'LAOS',	'MALI',	'OMAN',	'PERU',	'TOGO'],
  	...
  	History: [ 'FORBIDDEN CITY',	'PRINTING PRESS',	'QUEEN VICTORIA',	'HAILE SELASSIE',	'ENLIGHTENMENT',	'KLU KLUX KLAN',	'SIEGE WARFARE',	'INDO EUROPEAN',	'DOMESTICATION',	'CANNIBALISMS',	'GENGHIS KHAN',	'ISAAC NEWTON',	'INDUS VALLEY',	'NIKOLA TESLA',	'CANNIBALISM',	'PHOENICIANS',	'RENAISSANCE',	'WHICH HUNTS',	'ANGKOR WAT',	'BLITZKRIEG',	'CAPITALISM',	'GUILLOTINE',	'REVOLUTION',	'PYTHAGORAS',	'ASSYRIANS',	'CHURCHILL',	'COMMUNISM',	'CONFUCIUS',	'FEUDALISM',	'HOLOCAUST',	'JERUSALEM',	'KARL MARX',	'STONE AGE',	'APARTHEID',	'HAMMURABI',	'CUNEIFORM',	'ARISTOTLE',	'NIETZSCHE',	'ALEXANDER',	'SOCIALISM',	'BUDDHISM',	'CATAPULT',	'COLONIES',	'EINSTEIN',	'HINDUISM',	'IRON AGE',	'MUHAMMAD',	'MUHAMMAD',	'OTTOMANS',	'PERSIANS',	'PYRAMIDS',	'TELEGRAM',	'GERMANIC',	'REGICIDE',	'CONQUEST',	'SOCRATES',	'FORAGING',	'TIMBUKTU',	'CASTLES',	'CRUSADE',	'ICE AGE',	'JUDAISM',	'KNIGHTS',	'LINCOLN',	'MONGOLS',	'MUGHALS',	'MUMMIES',	'PHARAOH',	'SAMURAI',	'TEMPLES',	'PIRATES',	'GALILEO',	'GANDHI',	'HITLER',	'PANGEA',	'ROMANS',	'SHOGUN',	'STALIN',	'TAOISM',	'VOODOO',	'SPEARS',	'CANONS',	'PLAGUE',	'REVOLT',	'CELTS',	'CESAR',	'D DAY',	'GULAG',	'ISLAM',	'JESUS',	'LENIN',	'PLATO',	'IDOLS',	'BANTU',	'POPE',	'ZULU',	'ALI'],
  	Science: ['CLIMATE CHANGE',	'NERVOUS SYSTEM',	'METEOROLOGIST',	'BIOCHEMISTRY',	'PALEONTOLOGY',	'MICROBIOLOGY',	'ORNITHOLOGY',	'ELECTRICITY',	'ENVIRONMENT',	'EQUILIBRIUM',	'ALTERNATING',	'TEMPERATURE',	'PETRI DISH',	'HYPOTHESIS',	'STATISTICS',	'GEOPHYSICS',	'IMMUNOLOGY',	'EXPERIMENT',	'ENTOMOLOGY',	'BLACK HOLE',	'MINERALOGY',	'LABORATORY',	'SEISMOLOGY',	'COMPOSTING',	'EXTINCTION',	'MECHANICAL',	'EVOLUTION',	'RADIOLOGY',	'ASTRONOMY',	'ASTRONOMY',	'CONDUCTOR',	'ORGANISM',	'CHEMICAL',	'RESEARCH',	'PARTICLE',	'VARIABLE',	'MOLECULE',	'ANTIBODY',	'VECTORS',	'NEPTUNE',	'PIPETTE',	'PHYSICS',	'OBSERVE',	'MINERAL',	'ELEMENT',	'WEATHER',	'GENETIC',	'MEASURE',	'CLIMATE',	'GRAVITY',	'GEOLOGY',	'SCIENCE',	'CULTURE',	'SYNDROM',	'CURRENT',	'VOLTAGE',	'DYNAMIC',	'ENTROPY',	'ANOMALY',	'BOTANY',	'MOTION',	'ENERGY',	'RETORT',	'BEAKER',	'MATTER',	'ENZYME',	'SYSTEM',	'THEORY',	'TORQUE',	'SYSTEM',	'FACTOR',	'WEIGHT',	'VALUES',	'SCHEME',	'EARTH',	'VENUS',	'WEIGH',	'PHASE',	'BIOME',	'STARS',	'SCALE',	'MODEL',	'STUDY',	'POWER',	'ERROR',	'MASS',	'DATA',	'CELL',	'ATOM',	'LAWS',	'MARS',	'FACT',	'MOON',	'UNIT',	'LOAD',	'LAB',	'DNA'],
  	Texting: [ 'AFAIK',	'WUZUP',	'IRL',	'BFF',	'MRW',	'YNK',	'CSL',	'FTL',	'TTYL',	'OH',	'NSFW',	'PPL',	'NAGI',	'SMH',	'IMU',	'TLDR',	'POMS',	'ADIH',	'JK',	'IDC',	'BWL',	'IMO',	'WYWH',	'IIRC',	'RLRT',	'CS',	'GAHOY',	'TNTL',	'AFAIR',	'ASAP',	'HIFW',	'GOI',	'WTF',	'FB',	'AAMOF',	'YGTR',	'TIL',	'LOL',	'EMBM',	'OMDB',	'FIMH',	'SRSLY',	'IANAL',	'FTW',	'TBH',	'IFYP',	'AFAICT',	'PAW',	'POV',	'KPC',	'ILY',	'PBB',	'YMMV',	'SOML',	'JSYK',	'OC',	'OP',	'TMB',	'DAE',	'BUMP',	'PAH',	'IMHO',	'LOL',	'ASL',	'MFW',	'LMAO',	'DWH',	'SFW',	'GRAS',	'RBTL',	'AYOR',	'DIY',	'WTPA',	'PTB',	'TIA',	'TIME',	'BSAAW',	'DM',	'GMTA',	'FAWC',	'BAE',	'FWIW',	'NSFL',	'NBD',	'4AO',	'PRT',	'NTH',	'MSG',	'FYI',	'TFW',	'ZZZ',	'QQ',	'IMO',	'SSDD',	'ICYMI',	'JIC',	'IDC',	'PITR',	'OMW',	'GRATZ',	'GL',	'IDK',	'TTYL',	'BRB',	'NFS',	'BBBG',	'BBIAS',	'RUOK',	'CYT',	'DBMIB',	'DM',	'GFN',	'AFK']

  };
let categories = ['Country', 'Animal', 'Capital', 'Food', 'History','Science', 'Texting'];
